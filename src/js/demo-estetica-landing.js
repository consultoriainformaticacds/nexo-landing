async function enviarLum() {
  ...
  try {
    ...
    if (r.ok) { status.style.color='#8B5E52'; status.textContent='Turno solicitado. Te confirmamos pronto.'; document.getElementById('lum-nombre').value=''; document.getElementById('lum-contacto').value=''; document.getElementById('lum-servicio').value=''; document.getElementById('lum-mensaje').value=''; }
